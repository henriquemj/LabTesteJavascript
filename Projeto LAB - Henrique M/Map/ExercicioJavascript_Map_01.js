...
// -----------------------------
// Função segura para formatar a data no formato dd/mm/aaaa
...
acessosArray.forEach(a =>
  console.log(`${a.nome} (ID: ${a.id}) - Data de Acesso: ${formatarData(a.dataAcesso)}`)
);
...
acessosMap.forEach((qtd, chave) => {
  ...
  console.log(`${nome} (ID: ${id}) - Data de Acesso: ${formatarData(data)} - Total de Acessos: ${qtd}`);
});
